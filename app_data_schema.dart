...
if faild status=status.HTTP_208_ALREADY_REPORTED
"""

// login/ [name='login']
...
if password or username or email is wrong status=status.HTTP_401_UNAUTHORIZED
if content not valid status=status.HTTP_406_NOT_ACCEPTABLE
"""

...
//get data like this
      """
{
"email" : "youssef.ouahman.yo@gmail.com"
}
and return HTTP 200 OK with code like "3868"
if failed return status=status.HTTP_406_NOT_ACCEPTABLE
"""
...
//get data like this
      """
{
"email":"youssef.ouahman@gmail.com",
"new_password":"dell123"

} if sucess : return HTTP 200 OK 
else status=status.HTTP_406_NOT_ACCEPTABLE
  """
//finish

...
//if faild return status=status.HTTP_404_NOT_FOUND


// .../delete_user_url_profile/+id
//if faild return status=status.HTTP_404_NOT_FOUND
//
...
// .../upload_user_profile_picture
//get id and image if upload return status=status.HTTP_200_OK
//if faild return status=status.HTTP_417_EXPECTATION_FAILED
//if data not correctly return status=status.HTTP_406_NOT_ACCEPTABLE



// .../get_user_profile_picture/+token