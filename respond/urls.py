...
urlpatterns = [
     ...
     path('get_bare_user/token:<str:token>',views.get_user,name = "get_data_user"),
     path('get_user/single_url_profile/token:<str:token>',views.get_urls_profile,name = "get_data_urls"),
     path('get_full_user/token:<str:token>',views.get_full_user,name = "get_data-user_and_urls"),
